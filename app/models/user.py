...
#     # RELATIONSHIPS
#     user = db.relationship('User', back_populates='reviews')  # Review can only belong to one user
#     recipe = db.relationship('Recipe', back_populates='recipe_reviews')  # Review can only belong to one recipe
